...
CARDS = [
    ...
    {
        "list": "Done",
        "title": "Rewrite Project Docs from Harvest to Haul",
        "priority": "P0",
        "owner": "Patrick",
        "labels": "Docs",
        "estimate": "M",
        "story": "As a team, we need all project materials to reflect the Haul shopping comparison product.",
        "acceptance": "Proposal, product spec, launch plan, metrics plan, sprint plan, and research playbook all use Haul positioning.",
    },
    {
        "list": "Done",
        "title": "Package Alpha Zip v0.1.0",
        "priority": "P0",
        "owner": "Patrick",
        "labels": "Launch, QA",
        "estimate": "S",
        "story": "As a grader or tester, I need a downloadable zip that can be installed locally in Chrome.",
        "acceptance": "haul-v0.1.0.zip exists and contains the full haul-extension folder.",
    },
    {
        "list": "Done",
        "title": "Write README, Release Notes, and Privacy Policy",
        "priority": "P0",
        "owner": "Patrick",
        "labels": "Docs, Launch",
        "estimate": "M",
        "story": "As a tester, I need clear install instructions, release notes, and privacy information.",
        "acceptance": "README.md, RELEASE-NOTES.md, and PRIVACY.md exist in haul-extension and are linked from GitHub.",
    },
    {
        "list": "Done",
        ...
        "estimate": "M",
        "story": "As a user, I need Haul to safely render product data from external shopping sites.",
        "acceptance": "Unsafe product-data rendering and inline event handlers are removed; background messages are validated.",
    },
    {
        "list": "Done",
        "title": "Alpha Release Email Template",
        "priority": "P0",
        "owner": "Patrick",
        "labels": "Research, Launch",
        "estimate": "S",
        "story": "As a team, we need a reusable email to send the alpha to 10 reference customers.",
        "acceptance": "ALPHA-RELEASE-EMAIL.md includes install steps, test instructions, and feedback link placeholders.",
    },
    {
        "list": "Done",
        "title": "Project III Submission Materials",
        "priority": "P0",
        "owner": "Patrick",
        "labels": "Docs, Launch",
        "estimate": "S",
        "story": "As a team, we need a clear checklist and Canvas text for the Alpha Release submission.",
        "acceptance": "PROJECT-III-SUBMISSION.md exists with repo, release, Trello, install, and feedback details.",
    },
    {
        "list": "Done",
        "title": "Trello Sprint 1.D Plan Draft",
        "priority": "P0",
        "owner": "Patrick",
        "labels": "Docs, Launch",
        "estimate": "S",
        "story": "As a team, we need Sprint 1.D user stories and backlog ready to copy or seed into Trello.",
        "acceptance": "TRELLO-SPRINT-1D.md and the Trello seed script contain Done, Planned, QA, Backlog, and Blocked cards.",
    },
    {
