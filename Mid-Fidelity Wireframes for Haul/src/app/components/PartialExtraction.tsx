...
export function PartialExtraction() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-semibold text-[#3d3529] mb-2">Screen 6: Partial Extraction State</h2>
        <p className="text-[#8a7e72]">When AI can't extract all details - allow manual editing</p>
      </div>
      ...
      <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg border border-[#e5e5e5] p-6">
        <div className="flex items-start gap-3 mb-6 p-4 bg-amber-50 border-2 border-amber-200 rounded-xl">
          ...
          <div className="flex-1">
            <h3 className="font-bold text-sm text-[#3d3529] mb-1">Some details couldn't be extracted</h3>
        ...
        <div className="space-y-4 mb-6">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <button className="text-xs text-[#7a9e76] hover:text-[#6a8c66] font-medium">
                Change Image
              </button>
            </div>
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-[#e5e5e5] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#7a9e76]"
                />
              </div>
              <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                type="text"
                placeholder="$0.00"
                className="w-full px-3 py-2 border-2 border-[#fecaca] bg-[#fef2f2] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#7a9e76] focus:border-transparent"
              />
          ...
          <div>
            ...
            <select className="w-full px-3 py-2 border border-[#e5e5e5] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#7a9e76]">
              <option>Shoes</option>
      ...
      <div className="max-w-2xl mx-auto bg-[#e8f0e6] border-2 border-[#7a9e76] rounded-xl p-4">
        <h4 className="text-sm font-bold text-[#3d3529] mb-2">Handling Extraction Failures</h4>
